...
<head>
    ...
    <script>
        var url = "${base}/admin/apkManager/apkCreate";
    </script>
</head>
<body>
    ...
    <form class="layui-form" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="apkName" id="apkName" required  lay-verify="required" placeholder="请输入应用名称" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-upload">
            ...
            <button type="button" class="layui-btn layui-btn-normal" id="fileListBtn">选择多文件</button>
