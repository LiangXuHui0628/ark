package com.siro.ark.shiro;

import com.siro.ark.comm.constant.Setting;
import com.siro.ark.comm.shiro.ShiroUser;
import com.siro.ark.comm.util.ApplicationContextRegister;
import com.siro.ark.comm.util.Encodes;
...
public class AuthRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        IArkDevUserService arkDevUserService = ApplicationContextRegister.getBean(IArkDevUserService.class);
        ArkDevUser sysUser = arkDevUserService.getByLoginName(loginName);
        if (sysUser != null) {
            logger.info(sysUser.getUsername()+"登录");
            ...
            return new SimpleAuthenticationInfo(new ShiroUser(
                    ...
                    loginName,
                    sysUser.getAdmin(),
                    sysUser.getUserstate(),
                    sysUser.getUsertype(),
                    sysUser.getPhoto()),
                    sysUser.getPassword().substring(16),
