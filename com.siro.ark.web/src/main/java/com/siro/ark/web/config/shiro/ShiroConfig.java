package com.siro.ark.web.config.shiro;

import com.siro.ark.shiro.AuthRealm;
...
public class ShiroConfig {
   ...
   private Logger logger = org.slf4j.LoggerFactory.getLogger(getClass());
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/apiLayouts/**","anon");
        ...
        filterChainDefinitionMap.put("/study/**","anon");
        filterChainDefinitionMap.put("/touchapi/**","anon");
        ...
        filterChainDefinitionMap.put("/aboutDeveloper","anon");
